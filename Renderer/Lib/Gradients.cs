namespace Renderer.Lib
{
    public class Gradients
    {
        ...
        public Gradients(Vertex minYVert, Vertex midYVert, Vertex maxYVert)
        {
            ...
            m_depth[0] = minYVert.GetPosition().z;
            m_depth[1] = midYVert.GetPosition().z;
            m_depth[2] = maxYVert.GetPosition().z;
            ...
            m_oneOverZ[0] = 1.0f / minYVert.GetPosition().w;
            m_oneOverZ[1] = 1.0f / midYVert.GetPosition().w;
            m_oneOverZ[2] = 1.0f / maxYVert.GetPosition().w;
